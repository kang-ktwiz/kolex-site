...
const i18n = {
  ko: {
    ...
    blog_title:"최신 포스트", blog_sub:"AI가 매일 새 글을 자동으로 작성합니다 🤖",
    ...
    ai_f3_h:"일일 인사 자동 작성", ai_f3_p:"매일 3개 국어로 팬 인사 포스트 자동 생성",
    ...
    sub_title:"카카오톡으로 새 소식 받기",
    sub_desc:"카카오 채널을 추가하면 좋아하는 치어리더의 새 소식을 가장 먼저 받아보실 수 있어요.",
    sub_note:"채널 오픈 알림 전용 · 스팸 없음 · 언제든 차단 가능",
  ...
  en: {
    ...
    blog_title:"Latest Posts", blog_sub:"AI writes new posts automatically every day 🤖",
    ...
    ai_f3_h:"Daily Greetings Auto-Written", ai_f3_p:"Fan greeting posts auto-generated daily in 3 languages",
  ...
  ja: {
    ...
    blog_title:"最新投稿", blog_sub:"AIが毎日新しい記事を自動作成します 🤖",
    ...
    ai_f3_h:"日次挨拶自動作成", ai_f3_p:"毎日3カ国語でファン挨拶投稿を自動生成",
    ...
    sub_title:"LINEで新着情報を受け取る",
    sub_desc:"LINE公式アカウントを追加すると、お気に入りのチアリーダーの最新情報をいち早くお届けします。",
    sub_note:"チャンネル開設通知のみ・スパムなし・いつでもブロック可能",
    goods_badge:"Coming Soon",
  ...
  zh: {
    ...
    vid_tab_yt:"📺 YouTube", vid_tab_ig:"📸 Instagram Reels",
    blog_title:"最新文章", blog_sub:"AI每天自動撰寫新文章 🤖",
    ...
    ai_f3_h:"每日自動撰寫問候", ai_f3_p:"每天自動以3種語言生成粉絲問候文章",
    ...
    sub_title:"透過LINE接收新消息",
    sub_desc:"加入LINE官方帳號，搶先收到你最喜歡的啦啦隊員最新消息。",
    sub_note:"僅限頻道開放通知・無垃圾訊息・隨時可封鎖",
    goods_badge:"Coming Soon",
