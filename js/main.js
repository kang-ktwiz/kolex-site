...
const members = [
  ...
  { id:"jeong-huijeong", name:"정희정", nameEn:"Jeong Hui-jeong", nameJa:"チョン・ヒジョン", nameZh:"鄭希靜", role:"치어리더", roleEn:"Cheerleader", year:2002, height:167, ig:"_jung_u",      followers:"238K", sports:["baseball","basketball"],
...
const i18n = {
  ko: {
    ...
    vid_title:"최신 영상", vid_sub:"새 영상이 올라오면 바로 업데이트됩니다",
    ...
    editorial_title:"📰 대한민국 치어리딩 가이드", editorial_more:"전체 보기 →",
    etag_culture:"문화", etag_history:"역사", etag_global:"글로벌",
    etag_guide:"가이드", etag_team:"팀", etag_jp:"가이드", etag_tw:"가이드", etag_season:"시즌",
    etitle_culture:"KBO 치어리딩 — 세계가 주목하는 이유",
    edesc_culture:"경기장을 가득 채우는 열정의 문화",
    etitle_history:"한국 스포츠 치어리딩의 역사",
    edesc_history:"1980년대부터 현재까지 40년의 기록",
    etitle_global:"전 세계가 한국 치어리더에게서 눈을 떼지 못하는 5가지 이유",
    edesc_global:"K-스포츠 열풍의 진짜 이유",
    etitle_guide:"한국 치어리딩 완벽 가이드",
    edesc_guide:"신규 팬을 위한 모든 것",
    etitle_team:"KOLEX 스포츠 엔터테인먼트 소개",
    edesc_team:"한국 최정상 퍼포먼스 스쿼드 안내",
    etitle_jp:"일본 팬을 위한 KBO 치어리딩 가이드",
    edesc_jp:"日本のファンが知るべきすべて",
    etitle_tw:"대만 팬을 위한 한국 치어리딩 가이드",
    edesc_tw:"台灣粉絲必讀完整指南",
    etitle_season:"KOLEX 2026 시즌 미리보기",
    edesc_season:"올해 풀가동되는 스쿼드",
    ai_badge_title:"AI 초안 → 담당자 확인 → 발행",
    ai_badge_sub:"AI가 치어리더 일상 인사·영상 소개·마일스톤 글 초안을 작성하고, KOLEX 담당자 검토 후 발행됩니다",
    ai_live:"● LIVE",
    ai_feat_h:"KOLEX 팀이\n매일 업데이트",
    ai_feat_p:"이 사이트는 KOLEX 운영 시스템으로 운영됩니다. 치어리더들의 인스타그램·유튜브를 실시간 모니터링해 새 콘텐츠가 올라오면 KOLEX 팀이 직접 확인하고 사이트를 업데이트합니다.",
    ai_consent_note:"본 사이트의 치어리더 관련 콘텐츠는 소속 치어리더의 사전 동의 하에 제작·운영됩니다.",
    ai_f1_h:"최신 소식 빠른 업데이트", ai_f1_p:"인스타그램 최신 사진·게시물 빠르게 업데이트",
    ai_f2_h:"영상 자동 업데이트", ai_f2_p:"유튜브 새 영상 → 영상 소개 즉시 게시",
    ai_f3_h:"매일 새로운 팬 메시지", ai_f3_p:"매일 4개 국어로 팬들에게 인사 메시지 전달",
  ...
  en: {
    ...
    vid_title:"Featured Videos", vid_sub:"New videos added as soon as they drop",
    vid_tab_yt:"📺 YouTube", vid_tab_ig:"📸 Instagram Reels",
    ...
    editorial_title:"📰 Korean Cheerleading Guide", editorial_more:"View All →",
    etag_culture:"Culture", etag_history:"History", etag_global:"Global",
    etag_guide:"Guide", etag_team:"Team", etag_jp:"Guide", etag_tw:"Guide", etag_season:"Season",
    etitle_culture:"KBO Cheerleading — Why the World Is Watching",
    edesc_culture:"A culture of passion that fills the stadium",
    etitle_history:"History of Korean Sports Cheerleading",
    edesc_history:"40 years of records from the 1980s to today",
    etitle_global:"5 Reasons the World Can't Look Away from Korean Cheerleaders",
    edesc_global:"The real reason behind the K-sports fever",
    etitle_guide:"The Complete Korean Cheerleading Guide",
    edesc_guide:"Everything a new fan needs to know",
    etitle_team:"About KOLEX Sports Entertainment",
    edesc_team:"Korea's top performance squad",
    etitle_jp:"KBO Cheerleading Guide for Japanese Fans",
    edesc_jp:"Everything Japanese fans need to know",
    etitle_tw:"Korean Cheerleading Guide for Taiwanese Fans",
    edesc_tw:"Must-read complete guide for Taiwan fans",
    etitle_season:"KOLEX 2026 Season Preview",
    edesc_season:"The full squad in action this year",
  ...
  ja: {
    nav_sub:"チアリーダーズ", nav_members:"メンバー", nav_instagram:"インスタ", nav_videos:"動画", nav_about:"について", nav_contact:"お問い合わせ",
    ...
    editorial_title:"📰 韓国チアリーディングガイド", editorial_more:"全て見る →",
    etag_culture:"文化", etag_history:"歴史", etag_global:"グローバル",
    etag_guide:"ガイド", etag_team:"チーム", etag_jp:"ガイド", etag_tw:"ガイド", etag_season:"シーズン",
    etitle_culture:"KBOチアリーディング — 世界が注目する理由",
    edesc_culture:"スタジアムを埋め尽くす熱狂の文化",
    etitle_history:"韓国スポーツチアリーディングの歴史",
    edesc_history:"1980年代から現在まで40年の記録",
    etitle_global:"世界が韓国チアリーダーから目が離せない5つの理由",
    edesc_global:"Kスポーツ熱風の本当の理由",
    etitle_guide:"韓国チアリーディング完全ガイド",
    edesc_guide:"新規ファンのためのすべて",
    etitle_team:"KOLEXスポーツエンターテインメント紹介",
    edesc_team:"韓国トップパフォーマンスチーム",
    etitle_jp:"日本ファンのためのKBOチアリーディングガイド",
    edesc_jp:"日本のファンが知るべきすべて",
    etitle_tw:"台湾ファンのための韓国チアリーディングガイド",
    edesc_tw:"台湾ファン必読完全ガイド",
    etitle_season:"KOLEX 2026シーズンプレビュー",
    edesc_season:"今年フル稼働のスクワッド",
  ...
  zh: {
    ...
    ig_sub:"追蹤以獲取即時動態",
    vid_title:"最新影片", vid_sub:"新影片上線即時更新",
    vid_tab_yt:"📺 YouTube", vid_tab_ig:"📸 Instagram Reels",
    ...
    editorial_title:"📰 韓國啦啦隊指南", editorial_more:"查看全部 →",
    etag_culture:"文化", etag_history:"歷史", etag_global:"全球",
    etag_guide:"指南", etag_team:"隊伍", etag_jp:"指南", etag_tw:"指南", etag_season:"賽季",
    etitle_culture:"KBO啦啦隊 — 全世界關注的理由",
    edesc_culture:"充滿熱情的比賽文化",
    etitle_history:"韓國運動啦啦隊的歷史",
    edesc_history:"從1980年代至今40年的紀錄",
    etitle_global:"全世界無法移開視線的5大理由",
    edesc_global:"K體育熱潮背後的真正原因",
    etitle_guide:"韓國啦啦隊完整指南",
    edesc_guide:"新粉絲必備的一切知識",
    etitle_team:"KOLEX體育娛樂介紹",
    edesc_team:"韓國頂尖表演隊伍",
    etitle_jp:"日本粉絲專屬KBO啦啦隊指南",
    edesc_jp:"日本粉絲必知的一切",
    etitle_tw:"台灣粉絲必讀韓國啦啦隊指南",
    edesc_tw:"台灣粉絲必讀完整指南",
    etitle_season:"KOLEX 2026賽季預覽",
    edesc_season:"今年全面運作的隊伍",
