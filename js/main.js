...
const i18n = {
  ko: {
    ...
    sub_title:"🎂 치어리더 마일스톤 소식 알림",
    sub_desc:"카카오 채널을 추가하면 치어리더 기념일·마일스톤 소식이 있을 때 가장 먼저 알려드립니다.",
    sub_note:"마일스톤(기념일) 게시물 알림 전용 · 스팸 없음 · 언제든 차단 가능",
  ...
  ja: {
    ...
    sub_title:"📸 Instagramの新着投稿通知をLINEで受け取る",
    sub_desc:"LINE公式アカウントを追加すると、チアリーダーに新しいInstagram投稿があるたびにお知らせします。",
    sub_note:"Instagram新着投稿通知専用・スパムなし・いつでもブロック可能",
    goods_badge:"Coming Soon",
  ...
  zh: {
    ...
    sub_title:"📸 透過LINE接收Instagram新貼文通知",
    sub_desc:"加入LINE官方帳號，每當啦啦隊員有新的Instagram貼文時，將立即通知您。",
    sub_note:"僅限Instagram新貼文通知・無垃圾訊息・隨時可封鎖",
    goods_badge:"Coming Soon",
